...
peach_img = pygame.image.load("C:/Users/Asus/downloads/peach.png").convert_alpha()
donkeykong_img = pygame.image.load("C:/Users/Asus/downloads/donkeykong.png").convert_alpha()
